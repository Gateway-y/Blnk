...
/**
 * RetryableError wraps an error that indicates the caller should retry
 * the operation; specifically with a different challenge type.
 * (acmez `retryableErr`.)
 */
final class RetryableError extends \RuntimeException
{
    ...
    /** is reports whether the error chain contains a RetryableError (Go: errors.As). */
