...
/**
 * TokenizeRequest is the body of POST /identities/:id/tokenize
 * (Go: api/model/identity.go `TokenizeRequest`, `Fields []string json:"fields" binding:"required"`).
 */
final class TokenizeRequest implements \JsonSerializable
{
    /** @var string[] */
    public array $fields = [];
     ...
     */
    public static function fromArray(array $data, string $struct = 'TokenizeRequest'): self
    {
        $r = new self();
