...
/**
 * Gauge is the in-memory replacement for OTel `metric.Int64Gauge` /
 * `metric.Float64Gauge`. It keeps the last recorded value per attribute set
 * within the current PHP process; nothing is exported.
 */
final class Gauge
{
